MENU_ANALISI.MD
	...
	UTIITA_UFFICIO
		Utente e profilo di edge dell'ufficio si trova in questa path:
			C:\Users\walter.rossi\AppData\Local\Microsoft\Edge\User Data

	    Profilo di EDGE quello personale si trova qui:
	    	c:\Users\walter.rossi\AppData\Local\Microsoft\Edge\User Data\Personale\

	Note
		@analisi@menu_(analisi sui menu DI TUTTI I PROGETTI)
	...
	VOCI MENU
		...
		GEST_MENU_TB01_VOCI *** è IL PROGETTO*** ??? 
			Note
			...
			QUERY
				...
				GEST_MENU_Tb01Qry01_01_VOCI
					...
					schema
						...
						SELECT 
							GEST_MENU_Tb01_VOCI.CodMenu_s, 
							GEST_MENU_Tb01_VOCI.Menu_s, 
							GEST_MENU_Tb01_VOCI.NoteMenu_s, 
							GEST_MENU_Tb01_VOCI.COMANDO_s, 
							GEST_MENU_Tb01_VOCI.COD_PROGETTO_s, 
							GEST_MENU_Tb01_VOCI.PROGETTO_s, 
							GEST_MENU_Tb01_VOCI.bCanc, 
							GEST_MENU_Tb01_VOCI.bAgg, 
							GEST_MENU_Tb01_VOCI.bScel, 
							GEST_MENU_Tb01_VOCI.IDKeyArch, 
							GEST_MENU_Tb01_VOCI.IdOrd, 
							GEST_MENU_Tb01_VOCI.Msg01, 
							GEST_MENU_Tb01_VOCI.ID, 
							GEST_MENU_Tb01_VOCI.DATA_INS, 
							GEST_MENU_Tb01_VOCI.DATA_AGG, 
							GEST_MENU_Tb01_VOCI.TIMEOPER
				...
				GEST_MENU_Tb01Qry01_01_VOCI_TMP
					...
					schema
						SELECT 
							...
							GEST_MENU_Tb01_VOCI_TMP.Menu_s, 
							GEST_MENU_Tb01_VOCI_TMP.NoteMenu_s, 
							GEST_MENU_Tb01_VOCI_TMP.COMANDO_s, 
							GEST_MENU_Tb01_VOCI_TMP.COD_PROGETTO_s, 
							GEST_MENU_Tb01_VOCI_TMP.PROGETTO_s, 
							GEST_MENU_Tb01_VOCI_TMP.bCanc, 
							GEST_MENU_Tb01_VOCI_TMP.bAgg, 
							GEST_MENU_Tb01_VOCI_TMP.bScel, 
							GEST_MENU_Tb01_VOCI_TMP.IDKeyArch, 
							GEST_MENU_Tb01_VOCI_TMP.IdOrd, 
							GEST_MENU_Tb01_VOCI_TMP.Msg01, 
							GEST_MENU_Tb01_VOCI_TMP.ID, 
							GEST_MENU_Tb01_VOCI_TMP.DATA_INS, 
							GEST_MENU_Tb01_VOCI_TMP.DATA_AGG, 
							GEST_MENU_Tb01_VOCI_TMP.TIMEOPER
			...
			FORM
				...
				OGGETTI_FORM_TB02
					Note
						Le form per il progetto MENUT TB02 
		...
		GEST_MENU_TB02_FUNZIONI **** è IL PROGETTO **** ??? 
			Note
