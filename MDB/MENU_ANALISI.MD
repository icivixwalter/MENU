MENU_ANALISI.MD
	...
	Note
		@analisi@menu_(analisi sui menu e @progetto@menu)

		La gestione dei MENU  viene impostata in questa path:
			c:\CASA\LINGUAGGI\ACCESS\PROGETTI_MDB\MSYS_OGGETTI\MENU\

			START "APRI CARTELLA MENU" "c:\CASA\LINGUAGGI\ACCESS\PROGETTI_MDB\MSYS_OGGETTI\MENU\"

		il progetto di gestione è denominato in MENU_GESTIONE.mdb;  apri PROGETTO:

			START "APRI PROGETTO MENU" "c:\CASA\LINGUAGGI\ACCESS\PROGETTI_MDB\MSYS_OGGETTI\MENU\MDB\MENU_GESTIONE.mdb"
